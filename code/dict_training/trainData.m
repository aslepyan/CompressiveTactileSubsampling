...
for dataNameIdx=2%1:numObject % !!
    ...
    dictPath = fullfile(uupwd, 'data', dataStorageFolder, dataFolderName, dataFileName);
    disp('data loading...');
    load(dictPath)
...
% saved trained data
trainDataFileName = 'traningData_balloon.mat'; % !!
trainDataPath = fullfile('..\..\data\traningData\', trainDataFileName);
...
load(fullfile('..\..\data\traningData','traningData_balloon.mat'))
