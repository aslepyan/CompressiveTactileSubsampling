...
patchStepSizeArr = [8,8;
                    2,2;
                    2,2;]; % patch step size for each patch case
patDictDir = '..\..\data\traningData\dictionary_haar.mat'; % patch dict address
dictFileName = 'dictionary1.mat'; % file name of combined dict
