...
for dataNameIdx=1:30%1:numObject % !!
    ...
    recDatapath1 = fullfile(uupwd, 'data', dataStorageFolder, dataFolderName, recSignalFileName1);
    % recDatapath2 = fullfile(uupwd, 'data', dataStorageFolder, dataFolderName, recSignalFileName2);
    recDatapath3 = fullfile(uupwd, 'data', dataStorageFolder, dataFolderName, recSignalFileName3);
    recDatapath4 = fullfile(uupwd, 'data', dataStorageFolder, dataFolderName, recSignalFileName4);
    disp('data loading...');
    load(recDatapath1)
